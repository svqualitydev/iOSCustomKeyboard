...
internal enum Asset {
  ...
  internal enum Images {
    ...
    internal enum TopButtons {
      internal static let payments = ImageAsset(name: "speech-bubble")
      internal static let templates = ImageAsset(name: "paper-plane")
      internal static let scheduling = ImageAsset(name: "calendar")
    }
  }
}
